...
**Output:**
A ranked action score with recommendation reason codes.

**Human Action:**
SEO analysts review the highest-ranked pages and decide whether page titles, meta descriptions, or content should be improved.

**Cost of a Wrong Decision:**
Incorrect recommendations may waste optimization effort or delay improvements on pages with greater business impact.
...
- Results are presented using observed, measured, and decision-support language.
- No client names, domains, URLs, private search queries, or credentials are included.
- No claims are made about predicting Google's algorithm or proving causal SEO improvements.
- Metrics reported in this paper correspond to the executed notebooks in the repository.
- Recommendations are intended to support human decision-making and require manual review before implementation.
